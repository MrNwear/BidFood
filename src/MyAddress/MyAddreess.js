...
import { NAVIGATION_ADDRESS_SCREEN_PATH, NAVIGATION_NEW_ADDRESS_PATH } from '../navigation/routes';
...
export default function MyAddreess({ navigation }) {
    ...
    const getAddressForCheckbox = useSelector((state) => state.getAddress.getAddress)
    ...
    const deleteAddress = async (id) => {
        ...
        alert(result === true ? "Address deleted successfully" : "Address not deleted!")
        ...
        <View style={styles.container}>
            ...
            {(customerAddresses != null && customerAddresses.length > 0) && <FlatList
                ...
                address['src1'] = require('../assets/Icons/edit_image.png') */}
                                ...
                                <View style={{ flexDirection: 'row', }}>
                                    <TouchableOpacity onPress={() => onPressAddress(index)}>
                                        <View style={styles.imgView}>
                                            ...
                                            <Image source={require('../assets/Icons/edit_image.png')}
                                                style={{ width: 20, height: 20, resizeMode: 'center' }} />
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={() => onPressDeleteAddress(item.id)}>
                                        <View style={styles.imagView}>
                                            <Image source={require('../assets/Icons/delete_Icon.png')}
                                                style={{ width: 20, height: 20, resizeMode: 'center' }} />
                        ...
                        <Text style={styles.addressText}>{item.street[0]}, {item.postcode}, {item.city}, {item.country_id}</Text>


                        <View style={{ borderWidth: 1, marginTop: 20, borderColor: 'lightgray', marginRight: 20, marginLeft: 20 }}></View>
            ...
            <TouchableOpacity style={styles.BUTTON}
                ...
                <Image style={styles.image3} source={require('../assets/Icons/add.png')} />
...
const styles = StyleSheet.create({
    ...
    imagView: {
        backgroundColor: '#0C034C', width: 30,
        marginRight: 20, height: 30, alignItems: 'center',
        justifyContent: 'center', borderRadius: 20
    },
    imgView: {
        backgroundColor: '#B6B6B6', width: 30,
        marginRight: 20, height: 30, alignItems: 'center',
        justifyContent: 'center', borderRadius: 20,
