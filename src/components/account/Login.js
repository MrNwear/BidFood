...
const Login = ({ loading, error, success, navigation, auth: _auth, signIn: _signIn }) => {
  ...
  const renderMessages = () => {
    if (error) {
      return <Text style={styles.error(theme)}>Incorrect Password or Username. Please try again.</Text>;
    }
