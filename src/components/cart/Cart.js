  ...
  renderCart = () => {
    ...
    return (
      <View style={styles.container(theme)}>
        ...
        >
          <View style={{
            flex: 0.3, width: '80%', marginTop: '60%', justifyContent: 'center', alignItems: 'center',
            height: 100, backgroundColor: "#fff", borderWidth: 2, borderColor: '#8BC63E', alignSelf: 'center'
          }}>
            <View style={{justifyContent: 'center', alignItems:'center'}}>
              ...
              <TouchableOpacity
                style={{...styles.centerOnBothAxis, ...styles.addProductButton, paddingHorizontal:50, marginTop:40}}
                onPress={() => { this.setModalVisible(false);console.log('props cart',this.props.cart); NavigationService.navigate(NAVIGATION_LOGIN_PATH) }}
              >
          ...
          !!items?.length && (
            <View style={styles.bottomButtonContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={
                  this.props.customerToken ? this.onPressAddToCheckout
                    :
                    () => {
