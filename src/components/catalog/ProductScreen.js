...
export const ProductScreen = props => {
  ...
  useEffect(() => {
    ...
    //  console.log("Product", "Product ==> " + JSON.stringify(product));
      ...
      if(res==='s44' && product.extension_attributes['is_in_stock_s44']==true)
      {
       setInStock("true")
      }
      else if(res==='s45' && product.extension_attributes['is_in_stock_s45']==true)
      {
        setInStock("true")
      }
  ...
  const renderPrice = () => {
    if (selectedProduct) {
      return (
        <Price
          basePrice={selectedProduct.extension_attributes.price_with_vat}
    ...
    return (
      <Price
        ...
        discountPrice={finalPrice(product.custom_attributes, product.extension_attributes.price_with_vat)}
        currencySymbol={currencySymbol}
        currencyRate={currencyRate}
      />
    );
  ...
  const renderAddToCartButton = () => {
    ...
    return (
      <Button style={styles.buttonStyle(theme)} onPress={onPressAddToCart} disabled={isInStock==="true" ? false:true}>
