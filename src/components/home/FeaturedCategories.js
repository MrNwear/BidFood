...
import { NAVIGATION_CATEGORY_DRILL_PATH, NAVIGATION_FEATURED_CATEGORIES } from '../../navigation/routes';
import { getFeaturedCategoryProducts,setCurrentCategory,resetFilters } from '../../actions';
import place_holder2 from '../../assets/productDetails/place_holder2.png';
import { getCategoryThumbnailFromAttributes, getProductThumbnailFromAttributes } from '../../helper/product';
...
const FeaturedCategories = ({ homeCategories, style }) => {
  ...
  const productCategories = [
    { image: require('../../../resources/categories/soft_drinks.jpeg'), name: 'Beverages', id: '375' },
    {
      image: require('../../../resources/categories/meat.jpg'), name: 'Meat', id: '373'
    }, {
      image: require('../../../resources/categories/bakery.jpeg'), name: 'Bakery', id: '383'
    },
    {
      image: require('../../../resources/categories/appetizer.jpeg'), name: 'Appetizers', id: '380'
    },
    {
      image: require('../../../resources/categories/dairy.jpeg'), name: 'Dairy', id: '387'
    },
    {
      image: require('../../../resources/categories/ready_meals.png'), name: 'Ready Meals', id: '401'
    }
  ]
        ...
        showsHorizontalScrollIndicator={false}>
        {
          homeCategories?.map((item) => {
           ...
           // const imageUrl = getCategoryThumbnailFromAttributes(item);
            return <TouchableOpacity style={styles.fullImage} onPress={() => {
              ...
              <FastImage 
                ...
                resizeMode={'contain'} 
                source={{uri:'https://dev.bidfoodhome.ae'+item.custom_attributes[0].value}} />
              <View>
                <Text
                  type="subheading"
